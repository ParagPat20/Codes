...
#define I2S_PIN_MCK GPIO_NUM_10
#define I2S_PIN_BCK GPIO_NUM_11
#define I2S_PIN_WS GPIO_NUM_12
#define I2S_PIN_DIN GPIO_NUM_13
#define I2S_PIN_DOUT GPIO_NUM_14
...
// python3 tools/gen_sr_commands.py "Turn on the light,Switch on the light;Turn
// off the light,Switch off the light,Go dark;Start fan;Stop fan"
enum {
...
void onSrEvent(sr_event_t event, int command_id, int phrase_id) {
  ...
  case SR_EVENT_COMMAND:
    ...
    // }
    ESP_SR.setMode(
        SR_MODE_COMMAND); // Allow for more commands to be given, before timeout
    // ESP_SR.setMode(SR_MODE_WAKEWORD); // Switch back to WakeWord detection
    break;
  default:
...
void es7210_init(void) {
  ...
  es7210_i2c_config_t es7210_i2c_conf = {// .i2c_port = I2C_MASTER_NUM,
