...
*   [**Implementation Strategy & Software Codebase**](README.md) - Find all the ESP32 code, GUI application, and deep-dive technical specs here.
*   [**ESP-NOW Setup Guide**](ESP_NOW_SETUP_GUIDE.md) - Step-by-step instructions for pairing the Master and Slave ESP32s.
*   [**Quick Start Guide**](QUICK_START.md) - A 5-minute setup and calibration guide for the hardware.
...
3.  Go to the `RollopodCodes` directory and follow the [**ESP-NOW Setup Guide**](ESP_NOW_SETUP_GUIDE.md) to flash the firmware.
...
# ESP32 Controller Software Documentation
