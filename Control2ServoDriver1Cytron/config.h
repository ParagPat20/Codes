...
const ServoConfig SERVO_CONFIG[NUM_SERVOS] = {
    ...
    {"LMF", 4, false, 0, "L5"},  // L5 = channel 4
    
    // Left Back Leg
    {"LBC", 10, false, 0, "L11"}, // L11 = channel 10
    {"LBT", 9, false, 0, "L10"},   // L10 = channel 9
    {"LBB", 8, false, 0, "L9"},     // L9 = channel 8
    
    // Right Front Leg
    {"RFC", 2, false, 0, "R3"},    // R3 = channel 2 (PCA2)
    {"RFT", 1, false, 0, "R2"},   // R2 = channel 1 (PCA2)
    {"RFB", 0, false, 0, "R1"},    // R1 = channel 0 (PCA2)
    
    // Right Mid Leg (4 servos)
    {"RMC", 7, false, 0, "R8"},   // R8 = channel 7 (PCA2)
    {"RMT", 6, false, 0, "R7"},    // R7 = channel 6 (PCA2)
    ...
    {"RBB", 9, false, 0, "R10"}    // R10 = channel 9 (PCA2)
};
